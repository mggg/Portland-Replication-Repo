...
def make_dataframe_from_file(file_name, cand_type):
    ...
    for obj in json_objects:
        ...
        # print(cand_tuple, coh_tuple, np.unique(obj["results"][cand_type], return_counts=True))
...
def plot_hist(
    ...
    fig, axs = plt.subplots(*df.shape, figsize=(40,20))
    ...
    plot_title = f"hist_2_bloc_{cand_type}_wins_in_{'_'.join(zone.split())}_Portland"
    ...
    fig.text(x_position, y_position + arrow_length / 2 + 0.01, 'Few POC\nPref Cand.', 
            ha='center', va='bottom', fontsize=24, transform=fig.transFigure)
    fig.text(x_position, y_position - arrow_length / 2 - 0.01, 'Many POC\nPref Cand.', 
            ha='center', va='top', fontsize=24, transform=fig.transFigure)
...
def plot_hist_3(
    ...
    fig, axs = plt.subplots(*df.shape, figsize=(30,10))
    ...
    # Add text associated with the arrow using figure coordinates
    fig.text(x_position, y_position + arrow_length / 2 + 0.01, 'Few POC\nPref Cand.', 
            ha='center', va='bottom', fontsize=18, transform=fig.transFigure)
    fig.text(x_position, y_position - arrow_length / 2 - 0.01, 'Many POC\nPref Cand.', 
            ha='center', va='top', fontsize=18, transform=fig.transFigure)
...
if __name__ == "__main__":
    ...
    for cand_type in ["C"]:
        ...
        plot_hist_3(df1.loc[[(2,10),(3,10),(4,10)]], cand_type, "Zone 1", color_dict[cand_type], 0, 3,"_(2,3,4)_cross_section")
        plot_hist_3(df2.loc[[(2,10),(3,10),(4,10)]], cand_type, "Zone 2", color_dict[cand_type], 0, 3,"_(2,3,4)_cross_section")
        plot_hist_3(df3.loc[[(2,10),(3,10),(4,10)]], cand_type, "Zone 3", color_dict[cand_type], 0, 3,"_(2,3,4)_cross_section")
        plot_hist_3(df4.loc[[(2,10),(3,10),(4,10)]], cand_type, "Zone 4", color_dict[cand_type], 0, 3,"_(2,3,4)_cross_section")
        plot_hist_3(df_all.loc[[(2,10),(3,10),(4,10)]], cand_type, "All Zones", color_dict[cand_type], 0, 12,"_(2,3,4)_cross_section")